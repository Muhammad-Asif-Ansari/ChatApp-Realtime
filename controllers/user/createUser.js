...
export const CreateUser = async (req, res) => {
    ...
    try {
        ...
        const token = jwt.sign({ _id: createUser._id, email: createUser.email,username: createUser.username}, process.env.JWT_SECRET_KEY, { expiresIn: "1h" })
        transporter.sendMail({
            to: createUser.email,
            from: "muhammadasifansari101@gmail.com",
